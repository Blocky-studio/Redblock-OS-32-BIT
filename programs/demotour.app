...
.draw_end:
	...
	.box0msg2			db 'Press B to enter the tutorial, or', 0 
	.box0msg3			db 'press A to skip it.', 0
;	.box0msg4			db '(Or press P to skip everything.)', 0
	...
	.tsl2				db 32, 1Ah, 'Alt + F2: Mute the PC speaker', 13, 10
	.tsl3				db 32, 1Ah, 'Alt + F3: Unmute the PC speaker', 13, 10
	.tsl4				db 32, 1Ah, 'Alt + F4: Force-quit the application', 13, 10, 0
	...
	.adlib_msg			db 'Some applications may want to play synthesized polyphonic music.', 0
	.adlib_msg2			db 'Which sound device would you prefer to use?', 0
