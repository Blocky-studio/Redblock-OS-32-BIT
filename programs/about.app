...
.draw_license:
	...
	.introtext0				db '  RedblockOS: Copyright (C) Redblock enterprises, 2017-2020', 13, 10
	.introtext1				db '  MichalOS Font & logo: Copyright (C) Krystof Kubin, 2017-2020', 13, 10, 10
	...
	.licensetext:			incbin "../licenses/LICENSE"
							db 0
...
draw_background:
	...
	.title_msg			db 'About Redblock OS', 0
