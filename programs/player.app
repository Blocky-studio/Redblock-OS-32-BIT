...
; TODO: Polyphony in piano (with PS/2 driver), play duo, speed control when playing files
...
.callback:
	...
	.listitem0			db 'A 2.5 octave keyboard-controlled', 13, 10, \
						   'piano.', 13, 10, 10, \
						   'It will use the PC speaker for', 13, 10, \
						   'sound output, so only one note', 13, 10, \
						   'may be played at a time.', 0
						   
	.listitem1			db 'A 2.5 octave keyboard-controlled', 13, 10, \
						   'piano.', 13, 10, 10, \
